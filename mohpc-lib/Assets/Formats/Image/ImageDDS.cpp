...
const char* ImageError::DDS::BadHeader::what() const noexcept
{
...
const char* ImageError::DDS::UnsupportedDXGIFormat::what() const noexcept
{
...
const char* ImageError::DDS::UnsupportedFourCCFormat::what() const noexcept
{
...
const char* ImageError::DDS::UnsupportedRGBAFormat::what() const noexcept
{
