...
namespace MOHPC
{
	...
	class MOHPC_UTILITY_EXPORTS IMessageStream
	{
	public:
	...
	class MOHPC_UTILITY_EXPORTS FixedDataMessageStream : public IMessageStream
	{
	private:
		uint8_t* storage;
		size_t length;
	...
	class MOHPC_UTILITY_EXPORTS DynamicDataMessageStream : public IMessageStream
	{
	private:
		uint8_t* storage;
		size_t length;
