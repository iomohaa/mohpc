...
namespace MOHPC
{
	...
	namespace Network
	{
		...
		private:
			...
			public:
				Request_FetchServers(FoundServerCallback&& inCallback, MasterServerDone&& doneCallback);
		...
		public:
			MOHPC_EXPORTS ServerList(gameListType_e type);
