...
namespace MOHPC
{
	...
	public:
		MOHPC_EXPORTS void CopyLittle(void* dest, const void* src, size_t size) const;
		MOHPC_EXPORTS void CopyBig(void* dest, const void* src, size_t size) const;
	};

	extern MOHPC_EXPORTS const IEndian& Endian;
};
