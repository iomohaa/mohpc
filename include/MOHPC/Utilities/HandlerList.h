...
c::Type h; \
public: \
template<> MOHPC_EXPORTS void set<c>(c::Type&& handler) { h = std::forward<c::Type>(handler); }
...
template<> void notify<c>() const { if(h) h(); }
...
template<> void notify<c>(t1 a1) const { if(h) h(a1); }
...
template<> void notify<c>(t1 a1, t2 a2) const { if(h) h(a1, a2); }
...
template<> void notify<c>(t1 a1, t2 a2, t3 a3) const { if(h) h(a1, a2, a3); }
...
template<> void notify<c>(t1 a1, t2 a2, t3 a3, t4 a4) const { if(h) h(a1, a2, a3, a4); }
...
template<> void notify<c>(t1 a1, t2 a2, t3 a3, t4 a4, t5 a5) const { if(h) h(a1, a2, a3, a4, a5); }
...
template<> void notify<c>(t1 a1, t2 a2, t3 a3, t4 a4, t5 a5, t6 a6) const { if(h) h(a1, a2, a3, a4, a5, a6); }
...
template<> void notify<c>(t1 a1, t2 a2, t3 a3, t4 a4, t5 a5, t6 a6, t7 a7) const { if(h) h(a1, a2, a3, a4, a5, a6, a7); }
